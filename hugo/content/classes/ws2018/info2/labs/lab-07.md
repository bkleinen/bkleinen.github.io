...
1. First set up a Window that can handle drawing. Can you get the Window to draw an equilateral triangle? What is the largest one you can get on the screen? You can use this scaffold: [https://github.com/htw-imi-info2/Lab08_SierpinskiTriangle/tree/ws2018](https://github.com/htw-imi-info2/Lab08_SierpinskiTriangle/tree/ws2018)
