...
We have lots of rules for the labs, as they are used by many different people during the week. Usually we're in one of three available labs, you find [an overview here](https://imi-bachelor.htw-berlin.de/studium/labore/) as well as the [Laborordnung](https://imi-bachelor.htw-berlin.de/studium/labore/).
...
This first lab is really about getting started, getting to know the infrastructure and make sure that you are able to run Kara programs in Greenfoot yourself during the next week. If you feel bored, you might start off right away with working on the the [prelab of next week lab](../exercise-01).
