  ...
  hugo  --source hugo --destination ../public-htw --environment htw --baseURL https://home.htw-berlin.de/~kleinen/hugo
  ...
  scp -r -o StrictHostKeyChecking=no  _bin/hugo_deployment/steps.sh $HOST1:~/hugo-tunnel/steps.sh
